...
private:
  ...
  void insert_func_symbol(
    std::string  name,
    llvm::Value* ptr_var,
    llvm::Type*  ptr_type
  );
  void insert_symbol_symbol(
    std::string  name,
    llvm::Value* ptr_var,
    llvm::Type*  ptr_type
  );
  ...
  llvm::Type*
  build_mult_declaration_or_definition(ast::idx idx_declaration_or_definition);
  llvm::Type* build_declaration_or_definition(
    ast::idx    idx,
    llvm::Type* ptr_declaration_declarator
  );
  llvm::Type* build_declaration_declarator(ast::idx idx);
  llvm::Type*
  build_type(ast::idx idx_declarator, ast::idx idx_declaration_declarator);
  llvm::Type* build_pointer(
    llvm::Type* ptr_type_declaration_declarator,
    ast::idx    idx_declarator
  );
  llvm::Type*
  build_array(llvm::Type* ptr_unit_type, ast::idx idx_array_declarator);
  llvm::Type*
  ...
  void build_function_or_function_ptr(
    ast::idx    idx,
    llvm::Type* ptr_declaration_declarator
  );
