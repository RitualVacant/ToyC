...
private:
  ...
  spt::Expr      *build_expression(ast::idx idx_expression);


  // TODO
  spt::Statement *build_block(ast::idx idx_block);

  spt::Statement *build_if_statement(ast::idx idx_statement);
  spt::Statement *build_switch_statement(ast::idx idx_statement);
  spt::Statement *build_return_statement(ast::idx idx_statement);
  spt::Statement *build_while_statement(ast::idx idx_statement);
  spt::Statement *build_do_while_statement(ast::idx idx_statement);
  spt::Statement *build_for_statement(ast::idx idx_statement);
